      ...
      <div className={`fixed top-0 left-0 w-full z-300 px-4 md:px-12 py-4 md:py-6 flex justify-between items-center pointer-events-none transition-colors duration-500`}>
        ...
        <div className="pointer-events-auto flex items-center gap-3">
          <a 
            ...
            className="px-4 md:px-5 py-2.5 rounded-full flex items-center justify-center gap-2 font-medium text-[14px] md:text-[15px] tracking-wide transition-all duration-300 shadow-[0_8px_30px_rgba(0,0,0,0.12)] cursor-pointer border border-transparent backdrop-blur-lg bg-[#d00736] text-white hover:bg-[#b0062d] animate-[pulse-animation_1.5s_infinite] shadow-[#d00736]/40"
          >
              Apply Now
                ...
                >
                  ...
                  <div className="mt-16 lg:mt-auto relative group self-start">
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="bg-black text-white px-8 py-4 rounded-full cursor-pointer flex items-center gap-3 font-medium text-[15px] hover:bg-[#111] transition-all duration-300 animate-[pulse-animation_2s_infinite] shadow-black/40"
                    >
                        Apply Now
