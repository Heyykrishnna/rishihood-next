...
export default function Experience(){
    ...
    return(
        ...
        <div className="content-center  items-center bg-[#FBF7EF] w-full flex flex-col flex-nowrap gap-3 sm:gap-3.75 px-4 sm:px-8 md:px-12 lg:px-20 xl:px-50 py-4 sm:py-5 mt-8 sm:mt-12 md:mt-16 lg:mt-20">
            <div className="content-center items-center box-border flex flex-col lg:flex-row h-full gap-6 md:gap-8 lg:gap-6 flex-nowrap justify-center lg:justify-start w-full">
            <div className="w-fulllg:w-auto">
