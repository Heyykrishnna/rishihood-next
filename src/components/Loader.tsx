    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          className="fixed inset-0 z-9999 flex items-center justify-center bg-[#fcfaf5]"
        >
          <StyledWrapper>
...
const StyledWrapper = styled.div`
  ...
  .pl__ring--a {
    stroke: #d00736; /* Rishihood Red */
  }

  .pl__ring--b {
    animation-name: ringB;
    stroke: #ff6b35; /* Orange Accent */
  }

  .pl__ring--c {
    animation-name: ringC;
    stroke: #9b0527; /* Darker Red */
  }
